...
exports.default = fundLargestRect;
/**
...
var squaredDist = function squaredDist(a, b) {
  var deltax, deltay;
  deltax = b[0] - a[0];
  deltay = b[1] - a[1];
...
var rayIntersectsSegment = function rayIntersectsSegment(p, p1, p2) {
  var a, b, mAB, mAP, ref;
...
var pointInPoly = function pointInPoly(p, poly) {
  var a, b, c, i, n;
  i = -1;
  n = poly.length;
  b = poly[n - 1];
...
var pointInSegmentBox = function pointInSegmentBox(p, p1, q1) {
  var eps, px, py;
  eps = 1e-9;
  px = p[0];
  py = p[1];
...
var lineIntersection = function lineIntersection(p1, q1, p2, q2) {
...
var segmentsIntersect = function segmentsIntersect(p1, q1, p2, q2) {
  var p;
...
var polyInsidePoly = function polyInsidePoly(polyA, polyB) {
...
var rotatePoint = function rotatePoint(p, alpha, origin) {
...
var rotatePoly = function rotatePoly(poly, alpha, origin) {
...
var intersectPoints = function intersectPoints(poly, origin, alpha) {
 ...
 */
function fundLargestRect(poly, options) {
